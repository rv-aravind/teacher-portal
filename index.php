  ...
  <body>
    <div class="login">
      <div class="login_form">
        <h2 class="heading text-center">tailwebs.</h2>
        <?php if (isset($error)): ?>
        <p><?php echo $error; ?></p>
        <?php endif;?>
        <form method="POST" action="index.php">
          ...
          <div class="mb-3 password">
            ...
            <span class="icons eye-icon" id="togglePassword" style="cursor: pointer;">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <span class="icons password-icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
          ...
          <a
            href="#"
            class="forget-password text-end mb-3 text-primary d-block text-decoration-none"
            >Forgot Password?</a
          >
          <div class="text-center"><button type="submit" class="btn btn-primary login_btn">Login</button></div>
        </form>
      </div>
    </div>
    <script
